[index.html..html](https://github.com/user-attachments/files/28316990/index.html.html)
<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
...
function syncStageByDates(x){x.etapa=normalizeStage(x.etapa); if(x.etapa==='A produzir'&&x.entrada){x.etapa='Em produção'} if(x.etapa==='Concluído'&&x.entrega&&!x.previsao){x.previsao=x.entrega}}
